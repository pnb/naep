...
print('Num predictions:', model_fe.groupby('data_length').size())

df = model_featuretools
...
print('JSD 10 <=> 30:', jensenshannon(df[df.data_length == 10].pred.iloc[:-1],  # 30 sec is 1 short
